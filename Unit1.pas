...
uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms, Dialogs, StdCtrls, ExtCtrls, ComCtrls, Mask, IniFiles, fileCtrl, DateUtils, Math, Grids;
...
begin
  ...
  begin
    ...
    begin
      if i = 1 then
      begin
        if (((ord(fieldStr[i]) >= 48) and (ord(fieldStr[i]) <= 57)) or (ord(fieldStr[i]) = 45)) then
        begin
        end
        else
        begin
      ...
      //проверка на корректность значения поля, только цифры и точка
        if not (((ord(fieldStr[i]) >= 48) and (ord(fieldStr[i]) <= 57)) or (ord(fieldStr[i]) = 46)) then
        begin
          bool := false;
          break;
        end;
...
begin
  ...
  begin
    iniFile.WriteString('Быстрые общие параметры', 'Частотный диапазон обработки №' + intToStr(j + 1) + ' от', form1.sg.Cells[i, j]);
    iniFile.WriteString('Быстрые общие параметры', 'Частотный диапазон обработки №' + intToStr(j + 1) + ' до', form1.sg.Cells[i + 1, j]);
    inc(j);
  end;
end;
  ...
  begin
    case i of
      ...
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton7.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox3.Items[form1.ComboBox3.itemIndex]);
          if form1.mRbutton9.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton9.Caption);
          end;
          if form1.mRbutton10.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton10.Caption);
          end;
        end;
        if form1.mRbutton8.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton8.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton10.Caption);
        end;
      end;
      2:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton11.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox4.Items[form1.ComboBox4.itemIndex]);
          if form1.mRbutton13.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton13.Caption);
          end;
          if form1.mRbutton14.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton14.Caption);
          end;
        end;
        if form1.mRbutton12.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton12.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton14.Caption);
        end;
      end;
      3:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton15.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox5.Items[form1.ComboBox5.itemIndex]);

          if form1.mRbutton17.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton17.Caption);
          end;
          if form1.mRbutton18.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton18.Caption);
          end;
        end;
        if form1.mRbutton16.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton16.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton18.Caption);
        end;
      end;
      4:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton19.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox6.Items[form1.ComboBox6.itemIndex]);
          if form1.mRbutton21.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton21.Caption);
          end;
          if form1.mRbutton22.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton22.Caption);
          end;
        end;
        if form1.mRbutton20.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton20.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton22.Caption);
        end;
      end;
      5:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton23.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox7.Items[form1.ComboBox7.itemIndex]);
          if form1.mRbutton25.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton25.Caption);
          end;
          if form1.mRbutton26.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton26.Caption);
          end;
        end;
        if form1.mRbutton24.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton24.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton26.Caption);
        end;
      end;
      6:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton27.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox8.Items[form1.ComboBox8.itemIndex]);
          if form1.mRbutton29.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton29.Caption);
          end;
          if form1.mRbutton30.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton30.Caption);
          end;
        end;
        if form1.mRbutton28.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton28.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton30.Caption);
        end;
      end;
      7:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton31.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox9.Items[form1.ComboBox9.itemIndex]);
          if form1.mRbutton33.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton33.Caption);
          end;
          if form1.mRbutton34.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton34.Caption);
          end;
        end;
        if form1.mRbutton32.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton32.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton34.Caption);
        end;
      end;
      8:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton35.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox10.Items[form1.ComboBox10.itemIndex]);
          if form1.mRbutton37.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton37.Caption);
          end;
          if form1.mRbutton38.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton38.Caption);
          end;
        end;
        if form1.mRbutton36.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton36.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton38.Caption);
        end;
      end;
      9:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton39.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox11.Items[form1.ComboBox11.itemIndex]);
          if form1.mRbutton41.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton41.Caption);
          end;
          if form1.mRbutton42.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton42.Caption);
          end;
        end;
        if form1.mRbutton40.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton40.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton42.Caption);
        end;
      end;
      10:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton43.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox12.Items[form1.ComboBox12.itemIndex]);
          if form1.mRbutton45.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton45.Caption);
          end;
          if form1.mRbutton46.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton46.Caption);
          end;
        end;
        if form1.mRbutton44.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton44.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton46.Caption);
        end;
      end;
      11:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton3.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox13.Items[form1.ComboBox13.itemIndex]);
          if form1.mRbutton1.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton1.Caption);
          end;
          if form1.mRbutton2.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton2.Caption);
          end;
        end;
        if form1.mRbutton4.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton4.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton2.Caption);
        end;
      end;
      12:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton7.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox14.Items[form1.ComboBox14.itemIndex]);
          if form1.mRbutton5.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton5.Caption);
          end;
          if form1.mRbutton6.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton6.Caption);
          end;
        end;
        if form1.mRbutton8.Checked then
        begin
      ...
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton11.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox15.Items[form1.ComboBox15.itemIndex]);
          if form1.mRbutton9.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton9.Caption);
          end;
      ...
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton15.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox16.Items[form1.ComboBox16.itemIndex]);
          if form1.mRbutton13.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton13.Caption);
          end;
      ...
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton19.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox17.Items[form1.ComboBox17.itemIndex]);
          if form1.mRbutton17.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton17.Caption);
          end;
      ...
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton67.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox18.Items[form1.ComboBox18.itemIndex]);
          if form1.mRbutton69.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton69.Caption);
          end;
          if form1.mRbutton70.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton70.Caption);
          end;
        end;
        if form1.mRbutton68.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton68.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton70.Caption);
        end;
      end;
      17:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton71.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox19.Items[form1.ComboBox19.itemIndex]);
          if form1.mRbutton73.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton73.Caption);
          end;
          if form1.mRbutton74.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton74.Caption);
          end;
        end;
        if form1.mRbutton72.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton72.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton74.Caption);
        end;
      end;
      18:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton75.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox20.Items[form1.ComboBox20.itemIndex]);
          if form1.mRbutton77.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton77.Caption);
          end;
          if form1.mRbutton78.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton78.Caption);
          end;
        end;
        if form1.mRbutton76.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton76.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton78.Caption);
        end;
      end;
      19:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton79.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox21.Items[form1.ComboBox21.itemIndex]);
          if form1.mRbutton81.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton81.Caption);
          end;
          if form1.mRbutton82.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton82.Caption);
          end;
        end;
        if form1.mRbutton80.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton80.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton82.Caption);
        end;
      end;
      20:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton83.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox22.Items[form1.ComboBox22.itemIndex]);
          if form1.mRbutton85.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton85.Caption);
          end;
          if form1.mRbutton86.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton86.Caption);
          end;
        end;
        if form1.mRbutton84.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton84.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton86.Caption);
        end;
      end;
      21:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton87.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox23.Items[form1.ComboBox23.itemIndex]);
          if form1.mRbutton89.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton89.Caption);
          end;
          if form1.mRbutton90.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton90.Caption);
          end;
        end;
        if form1.mRbutton88.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton88.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton90.Caption);
        end;
      end;
      22:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton91.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox24.Items[form1.ComboBox24.itemIndex]);
          if form1.mRbutton93.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton93.Caption);
          end;
          if form1.mRbutton94.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton94.Caption);
          end;
        end;
        if form1.mRbutton92.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton92.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton94.Caption);
        end;
      end;
      23:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton95.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox25.Items[form1.ComboBox25.itemIndex]);
          if form1.mRbutton97.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton97.Caption);
          end;
          if form1.mRbutton98.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton98.Caption);
          end;
        end;
        if form1.mRbutton96.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton96.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton98.Caption);
        end;
      end;
      24:
      begin
        ...
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton99.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Чувствительность', form1.ComboBox26.Items[form1.ComboBox26.itemIndex]);
          if form1.mRbutton101.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton101.Caption);
          end;
          if form1.mRbutton102.Checked then
          begin
            iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton102.Caption);
          end;
        end;
        if form1.mRbutton100.Checked then
        begin
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние', form1.mRbutton100.Caption);
          iniFile.WriteString('Канал ' + intToStr(i), 'Состояние ФВЧ', form1.mRbutton102.Caption);
        end;
      end;
    end;
...
begin
  ...
  begin
    case i of
      ...
      begin
        if form1.mRbutton1.Checked then
        begin
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Состояние', form1.mRbutton1.Caption);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон температуры от', form1.mEdit10.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон температуры до', form1.mEdit11.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Номер канала темп.', form1.ComboBox28.Items[form1.ComboBox28.itemIndex]);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон влажности от', form1.mEdit12.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон влажности до', form1.mEdit13.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Номер канала влаж.', form1.ComboBox29.Items[form1.ComboBox29.itemIndex]);
        end;
        if form1.mRbutton2.Checked then
        begin
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Состояние', form1.mRbutton2.Caption);
        end;
      end;
      2:
      begin
        if form1.mRbutton3.Checked then
        begin
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Состояние', form1.mRbutton3.Caption);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон температуры от', form1.mEdit17.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон температуры до', form1.mEdit18.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Номер канала темп.', form1.ComboBox30.Items[form1.ComboBox30.itemIndex]);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон влажности от', form1.mEdit19.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Диапазон влажности до', form1.mEdit20.Text);
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Номер канала влаж.', form1.ComboBox31.Items[form1.ComboBox31.itemIndex]);
        end;
        if form1.mRbutton4.Checked then
        begin
          iniFile.WriteString('Датчик температуры\влажности №' + intToStr(i), 'Состояние', form1.mRbutton4.Caption);
        end;
      end;
    end;
  end;        
  ...
  if form1.mRbutton5.Checked then
  begin
    iniFile.WriteString('Датчик давления', 'Состояние', form1.mRbutton5.Caption);
    iniFile.WriteString('Датчик давления', 'Диапазон давления от', form1.mEdit24.Text);
    iniFile.WriteString('Датчик давления', 'Диапазон давления до', form1.mEdit25.Text);
    iniFile.WriteString('Датчик давления', 'Номер канала дав.', form1.ComboBox33.Items[form1.ComboBox33.itemIndex]);
  end;
  if form1.mRbutton6.Checked then
  begin
    iniFile.WriteString('Датчик давления', 'Состояние', form1.mRbutton6.Caption);
  end;
end;
...
begin
  ...
  //общие параметры
  iniFile.WriteString('Общие параметры', 'Длительность обр. интервала', form1.MaskEdit2.Text);
  iniFile.WriteString('Общие параметры', 'Количество обр. интервалов в кадре', form1.MaskEdit3.Text);
  //быстрые общие параметры
  iniFile.WriteString('Быстрые общие параметры', 'Частота дискретизации', form1.ComboBox27.Items[form1.ComboBox27.Itemindex]);
  iniFile.WriteString('Быстрые общие параметры', 'Разница скорости движения', form1.ComboBox1.Items[form1.ComboBox1.ItemIndex]);
  iniFile.WriteString('Быстрые общие параметры', 'Граница ФНЧ', form1.ComboBox2.Items[form1.ComboBox2.ItemIndex]);
  iniFile.WriteString('Быстрые общие параметры', 'Граница гистограммы обработки от', form1.mEdit36.Text);
  iniFile.WriteString('Быстрые общие параметры', 'Граница гистограммы обработки до', form1.mEdit5.Text);
  iniFile.WriteString('Быстрые общие параметры', 'Интервал гистограммы обработки', form1.mEdit37.Text);
  //заполнение частотных диапазонов
  FillFreqRangies(iniFile);
  //!!!!!(((((())))))!!!!!!!!!!!!
  //медленные общие параметры
  iniFile.WriteString('Медленные общие параметры', 'Частота дискретизации', form1.mEdit16.Text);
  //заполнение быстрых
...
begin
  ...
  begin
    bool := ((StrToInt(StringReplace(field.Text, ' ', '', [rfReplaceAll])) >= begRange)
      and (StrToInt(StringReplace(field.Text, ' ', '', [rfReplaceAll])) <= endRange));
  end
  else
  begin
    bool := false;
...
//
//==============================================================================
procedure CheckSubInterval(intervalBeg: TMaskEdit; intervalEnd: TMaskEdit; step: TMaskEdit);
var
...
begin
  ...
  begin
    ...
    if (((ord(str[k]) >= 192) and (ord(str[k]) <= 255)) or ((ord(str[k]) = 45) or (ord(str[k]) = 32))) then
    begin
      //первая буква заглавная
      if (((ord(str[k]) >= 224) and (ord(str[k]) <= 255)) and (k = 1)) then
      begin
        bool := false;
        errorNum := 2;
        break;
      ...
      begin
        ...
        if (((str[k - 1] = ' ') or (str[k - 1] = '-')) and ((ord(str[k]) >= 224) and (ord(str[k]) <= 255))) then
        begin
          bool := false;
          errorNum := 2;
          break;
...
begin
  ...
  begin
    //в буфере только русские буквы,пробел и тире
    if (((ord(str[k]) >= 192) and (ord(str[k]) <= 255)) or ((ord(str[k]) = 45)
      or (ord(str[k]) = 32)) or ((ord(str[k]) >= 48) and (ord(str[k]) <= 57))) then
    begin
      bufStr := bufStr + str[k];
    end
    else
...
begin
  ...
  begin
    ...
    begin
      //str:=sg.Cells[i,j];
      //str:=sg.Cells[i+1,j];
      if ((not CheckField(sg.Cells[i, j], begRangeF, endRangeF))
        and (not CheckField(sg.Cells[i, j + 1], begRangeF, endRangeF))) then
      begin
        bool := false;
        errorNum := 15;
        break;
...
begin
  ...
  begin
    ...
    if (bool) then
    begin
      if ((not CheckField(form1.mEdit10, begRangeF, endRangeF)) and (not CheckField(form1.mEdit11, begRangeF, endRangeF))) then
      begin
        bool := false;
        errorNum := 5;
      end;
    ...
    if (bool) then
    begin
      if ((not CheckField(form1.mEdit12, begRangeF, endRangeF)) and (not CheckField(form1.mEdit13, begRangeF, endRangeF))) then
      begin
        bool := false;
        errorNum := 6;
      end;
  ...
  begin
    ...
    if (bool) then
    begin
      if ((not CheckField(form1.mEdit17, begRangeF, endRangeF)) and (not CheckField(form1.mEdit18, begRangeF, endRangeF))) then
      begin
        bool := false;
        errorNum := 5;
      end;
    ...
    if (bool) then
    begin
      if ((not CheckField(form1.mEdit19, begRangeF, endRangeF)) and (not CheckField(form1.mEdit20, begRangeF, endRangeF))) then
      begin
        bool := false;
        errorNum := 6;
      end;
  ...
  begin
    ...
    if (bool) then
    begin
      if ((not CheckField(form1.mEdit24, begRangeF, endRangeF)) and (not CheckField(form1.mEdit25, begRangeF, endRangeF))) then
      begin
        bool := false;
        errorNum := 9;
      end;
...
procedure FillChildComponentsList(const SourceComponent: TComponent; var ChildsList: TList);
var
  i: Integer;
begin
...
begin
  case errorNum of
    ...
    23:
      begin
        ShowMessage('Ошибка! Количество интервалов в гистограмме не должно превышать ' + intToStr(MAX_SUBINTERVAL_NUM));
      end;
  end;
end;
...
begin
  ...
  if SelectDirectory('Выберите каталог для сохранения конфигурационного файла ', '\', chosenDirectory) then
  begin
...
var
  sens: real;
begin
  sens := ((abs(StrToFloat(begRange.Text))) + (abs(StrToFloat(endRange.Text)))) / 10;
...
begin
  ...
  begin
    if ((TestStr(form1.mEdit36.Text)) and (TestStr(form1.mEdit5.Text)) and (TestStr(form1.mEdit37.Text))) then
    begin
